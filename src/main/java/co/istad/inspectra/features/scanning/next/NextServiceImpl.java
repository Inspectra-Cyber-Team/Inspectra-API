...
public class NextServiceImpl implements NextService{
    ...
    public String nextScanning(NextScanningRequest nextScanningRequest) {
        ...
        String fileName = gitConfig.gitClone(nextScanningRequest.gitUrl(), nextScanningRequest.branch(), cloneDirectory,"");

        List<String> command = getStrings(nextScanningRequest.projectName(), cloneDirectory, fileName);
